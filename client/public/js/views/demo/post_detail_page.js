define([
  ...
  'views/demo/index',
  'views/demo/post_detail'
], function( Vm, indexTemplate,HeaderView,ServerNotOkView,ServerOkCollection,IndexView,PostDetailView){
      ...
      var serverok = new ServerOkCollection();
        serverok.fetch({
          success:function(res){
              ...
              headerView.render();
              var pageView =  Vm.create(this,'pageView', PostDetailView,that.options);
              pageView.render();
          },
